...
class OpenAPIOperation(AbstractOperation):
    ...
    def _get_body_argument(self, body, arguments, has_kwargs, sanitize):
        if self.consumes[0] in FORM_CONTENT_TYPES:
            return self._get_body_argument_form(body, arguments, has_kwargs, sanitize)
        else:
            return self._get_body_argument_json(body, arguments, has_kwargs, sanitize)

    def _get_body_argument_json(self, body, arguments, has_kwargs, sanitize):
